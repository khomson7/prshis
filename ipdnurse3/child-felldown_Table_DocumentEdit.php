 ...
 require_once '../include/main-include.php';
        ...
        if($docmain2){
            ...
            <tr>
                    ...
                    <td><a href="child-felldown.php?an=<?=$an?>&id=<?=$ids?>&loginname=<?=$login?>" target="_blank">แบบประเมินภาวะพลัดตกหกล้มผู้ป่วยทารกและเด็ก (วันที่ <?=date("d/m/Y", strtotime($create_datetimeAddmissionNurse))?>)</a></td>
