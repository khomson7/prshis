...
<buton >
<a class="nav-link" href="/pdffile/bedscore-pdf.php?an=<?php echo $an; ?>&loginname=<?php echo $loginname; ?>" target="_blank" class="btn btn-secondary"><i class="fas fa-file-pdf"></i> Print <U>PDF</U> File</a>
</buton> 
...
<script>
    function onclick_check_DocumentAdd(){
        var url = "form-bedscore_check_DocumentAdd.php";
    ...
    function check_Table_DocumentEdit(){
        var url = "form-bedscore_Table_DocumentEdit.php";
        var an  = <?=json_encode($an)?>;
        $.post(url,{an},function(data){
