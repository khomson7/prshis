<?php   require_once '../include/main-include.php';
        ...
        if(($an)){
            ?><a class="dropdown-item" href="form-felldown.php?an=<?=$an?>&loginname=<?php echo $loginname; ?>" target="_blank"><em class="fas fa-file-alt"></em> <?= htmlspecialchars($menuname) ?></a><?php
        }
