...
if (
    $row['feeding_dc'] == null && $row['tranfer_dc'] == null && $row['grooming_dc'] == null && $row['toilet_use_dc'] == null && $row['bathing_dc'] == null
                    ...
                    <div class="card-body" style=" overflow-y: auto;">
                        ...
                        <div class="row">
                            ...
                            <div class="custom-control custom-radio col-2 col-md-2">
                                ...
                                } ?> class="custom-control-input" id="chronic_check1"
                                    name="chronic_check" value="1">
                                <label class="custom-control-label" for="chronic_check1"
                                    style="font-size:100%; background-color:yellow;"><strong>&nbsp;Stroke&nbsp;</strong></label>
                            </div>
                            <div class="custom-control custom-radio col-2 col-md-2">
                                <input type="radio" <?php if ($row['chronic_check'] == '2') {
                                    echo 'checked="checked"';
                                } ?> class="custom-control-input" id="chronic_check2" name="chronic_check" value="2">
                                <label class="custom-control-label" for="chronic_check2"
                                    style="font-size:100%; background-color:orange;"><strong>&nbsp;TBI&nbsp;</strong></label>
                            </div>
                            <div class="custom-control custom-radio col-2 col-md-2">
                                <input type="radio" <?php if ($row['chronic_check'] == '3') {
                                    echo 'checked="checked"';
                                } ?> class="custom-control-input" id="chronic_check3" name="chronic_check" value="3">
                                <label class="custom-control-label" for="chronic_check3"
                                    style="font-size:100%; background-color:gray;"><strong>&nbsp;SCI&nbsp;</strong></label>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12">
                                ...
                                <table lass="center" id="bg-table" width="100%"
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            width="5%">&nbsp;<b>กิจกรรม</b></td>
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;<b>แบบประเมินกิจวัตรประจำวันของผู้ป่วย (Barthel index)</b>
                                        </td>
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            width="1%">&nbsp;<b>Admit</b></td>
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            width="1%">&nbsp;<b>D/C</b></td>
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            width="1%">&nbsp;<b></b></td>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="5%" rowspan="4">&nbsp;<b>1.Feeding
                                                รับประทานอาหารเมื่อเตรียมสำรับไว้ให้เรียบร้อยต่อหน้า</b></td>
                                    </tr>

                                    <tr style="border:1px solid #000;margin: 45px;">

                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;0 = ไม่สามารถตักอาหารเข้าปากเองได้</td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['feeding'] == '1') {
                                                    echo 'checked="checked"';
                                                } ?>class="custom-control-input" id="feeding0"
                                                    value='1' name="feeding" oninput="feedingCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="feeding0" style="font-size:100%;">0</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['feeding_dc'] == '1') {
                                                    ...
                                                    id="feeding_dc0" value="1" name="feeding_dc"
                                                    oninput="feedingDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="feeding_dc0" style="font-size:100%;">0</label>
                                            </div>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;5 = ตักอาหารเองได้ แต่ต้องมีคนช่วย เช่น
                                            ช่วยใช้ช้อนตักอาหารเตรียมไว้ / ตัดเป็นชิ้น</td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['feeding'] == '5') {
                                                    echo 'checked="checked"';
                                                } ?>class="custom-control-input" id="feeding5"
                                                    value="5" name="feeding" oninput="feedingCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="feeding5" style="font-size:100%;">5</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['feeding_dc'] == '5') {
                                                    ...
                                                    id="feeding_dc5" value="5" name="feeding_dc"
                                                    oninput="feedingDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="feeding_dc5" style="font-size:100%;">5</label>
                                            </div>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;10 = ตักอาหารและช่วยตัวเองได้ปกติ</td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['feeding'] == '10') {
                                                    echo 'checked="checked"';
                                                } ?>class="custom-control-input" id="feeding10"
                                                    value="10" name="feeding" oninput="feedingCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="feeding10" style="font-size:100%;">10</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['feeding_dc'] == '10') {
                                                    ...
                                                    id="feeding_dc10" value="10" name="feeding_dc"
                                                    oninput="feedingDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="feeding_dc10" style="font-size:100%;">10</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['tranfer'] == '1') {
                                                    echo 'checked="checked"';
                                                } ?>class="custom-control-input" id="tranfer0"
                                                    value="1" name="tranfer" oninput="tranferCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="tranfer0" style="font-size:100%;">0</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['tranfer_dc'] == '1') {
                                                    ...
                                                    id="tranfer_dc0" value="1" name="tranfer_dc"
                                                    oninput="tranferDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="tranfer_dc0" style="font-size:100%;">0</label>
                                            </div>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px; background-color:#d4fbfb">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            ต้องใช้คน 1-2คนพยุงจึงจะนั่งได้</td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['tranfer'] == '5') {
                                                    echo 'checked="checked"';
                                                } ?>class="custom-control-input" id="tranfer5"
                                                    value="5" name="tranfer" oninput="tranferCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="tranfer5" style="font-size:100%;">5</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['tranfer_dc'] == '5') {
                                                    ...
                                                    id="tranfer_dc5" value="5" name="tranfer_dc"
                                                    oninput="tranferDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="tranfer_dc5" style="font-size:100%;">5</label>
                                            </div>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px; background-color:#d4fbfb">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            บอกให้ทำตามช่วยพยุงเล็กน้อย</td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['tranfer'] == '10') {
                                                    echo 'checked="checked"';
                                                } ?>class="custom-control-input" id="tranfer10"
                                                    value="10" name="tranfer" oninput="WettingTheSkinCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="tranfer10" style="font-size:100%;">10</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['tranfer_dc'] == '10') {
                                                    ...
                                                    id="tranfer_dc10" value="10" name="tranfer_dc"
                                                    oninput="tranferDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="tranfer_dc10" style="font-size:100%;">10</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['tranfer'] == '15') {
                                                    echo 'checked="checked"';
                                                } ?>class="custom-control-input" id="tranfer15"
                                                    value="15" name="tranfer" oninput="WettingTheSkinCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="tranfer15" style="font-size:100%;">15</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['tranfer_dc'] == '15') {
                                                    ...
                                                    id="tranfer_dc15" value="15" name="tranfer_dc"
                                                    oninput="tranferDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="tranfer_dc15" style="font-size:100%;">15</label>
                                            </div>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="5%" rowspan="3">&nbsp;<b>3.Grooming การล้างหน้า หวีผม แปรงฟัน
                                                โกนหนวด</b></td>
                                    </tr>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;0 = ต้องการความช่วยเหลือ</td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['grooming'] == '1') {
                                                    echo 'checked="checked"';
                                                } ?>class="custom-control-input" id="grooming0"
                                                    value="1" name="grooming" oninput="groomingCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="grooming0" style="font-size:100%;">0</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['grooming_dc'] == '1') {
                                                    ...
                                                    id="grooming_dc0" value="1" name="grooming_dc"
                                                    oninput="groomingDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="grooming_dc0" style="font-size:100%;">0</label>
                                            </div>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;5 = ทำได้เอง (รวมทั้งที่ทำได้เอง ถ้าเตรียมอุปกรณ์ไว้ให้)
                                        </td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['grooming'] == '5') {
                                                    echo 'checked="checked"';
                                                } ?>class="custom-control-input" id="grooming5"
                                                    value="5" name="grooming" oninput="groomingCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="grooming5" style="font-size:100%;">5</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['grooming_dc'] == '5') {
                                                    ...
                                                    id="grooming_dc5" value="5" name="grooming_dc"
                                                    oninput="groomingDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="grooming_dc5" style="font-size:100%;">5</label>
                                            </div>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px; background-color:#d4fbfb">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            ทำความสะอาดได้เรียบร้อยหลังเสร็จ)</td>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="5%" rowspan="3">&nbsp;<b>5.Bathing การอาบน้ำ</b></td>
                                    </tr>

                                    <tr style="border:1px solid #000;margin: 45px;">

                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;0 = ต้องมีคนช่วยหรือทำให้</td>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px; background-color:#d4fbfb">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;5 =
                                            ต้องใช้รถเข็นช่วยตัวเองให้เคลื่อนที่ได้เอง(ไม่ต้องมีคนช่วยเข็น)</td>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="5%" rowspan="4">&nbsp;<b>7.Stairs การขึ้นลงบันได 1 ขั้น</b></td>
                                    </tr>

                                    <tr style="border:1px solid #000;margin: 45px;">

                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;0 = ไม่สามารถทำได้</td>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;5 = ต้องการคนช่วยเหลือ</td>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;10 = ขึ้นลงเองได้ (ถ้าต้องการใช้อุปกรณ์ เช่น walker)</td>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="5%" rowspan="4">&nbsp;<b>9.Bowel การกลั้นการถ่ายอุจจาระ ใน 1
                                                สัปดาห์ที่ผ่านมา
                                            </b></td>
                                    </tr>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;0 = กลั้นไม่ได้ หรือต้องการสวนอุจจาระอยู่เสมอ</td>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;5 = กลั้นไม่ได้เป็นบางครั้ง(ไม่เกิน 1 สัปดาห์ต่อครั้ง)
                                        </td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['bladder_dc'] == '5') {
                                                    ...
                                                    id="bladder_dc5" value="5" name="bladder_dc"
                                                    oninput="bladderDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="bladder_dc5" style="font-size:100%;">5</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['bladder'] == '10') {
                                                    echo 'checked="checked"';
                                                } ?>class="custom-control-input" id="bladder10"
                                                    value="10" name="bladder" oninput="bladdercheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="bladder10" style="font-size:100%;">10</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['bladder_dc'] == '10') {
                                                    ...
                                                    id="bladder_dc10" value="10" name="bladder_dc"
                                                    oninput="bladderDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="bladder_dc10" style="font-size:100%;">10</label>
                                            </div>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            width="5%" rowspan="2">&nbsp;<b>รวมคะแนน</b></td>
                                    </tr>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px; font-size: 20px;"
                                            width="1%">
                                            <div>
                                ...
                                <table lass="center" id="bg-table" width="100%"
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            width="5%">&nbsp;<b></b></td>
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;<b>THE MODIFIED RANKIN SCALE</b></td>
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            width="1%">&nbsp;<b>Admit</b></td>
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            width="1%">&nbsp;<b>D/C</b></td>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;ไม่มีความผิดปกติเลย</td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale'] == '9') {
                                                    ...
                                                    id="rankin_scale0" value="9" name="rankin_scale"
                                                    oninput="rankinScaleCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale0" style="font-size:100%;">0</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale_dc'] == '9') {
                                                    ...
                                                    id="rankin_scale_dc0" value="9" name="rankin_scale_dc"
                                                    oninput="rankinScaleDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale_dc0" style="font-size:100%;">0</label>
                                            </div>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        ...
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;ไม่มีความผิดปกติที่รุนแรง
                                            สามารถทำกิจวัตรประจำวันได้ทุกอย่าง ทำงานอาชีพได้</td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale'] == '1') {
                                                    ...
                                                    id="rankin_scale1" value="1" name="rankin_scale"
                                                    oninput="rankinScaleCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale1" style="font-size:100%;">1</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale_dc'] == '1') {
                                                    ...
                                                    id="rankin_scale_dc1" value="1" name="rankin_scale_dc"
                                                    oninput="rankinScaleDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale_dc1" style="font-size:100%;">1</label>
                                            </div>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="5%">&nbsp;2</td>
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;มีความผิดปกติเล็กน้อย สามารถทำกิจวัตรประจำวันได้ทุกอย่าง
                                            แต่ทำงานอาชีพไม่ได้</td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale'] == '2') {
                                                    ...
                                                    id="rankin_scale2" value="2" name="rankin_scale"
                                                    oninput="rankinScaleCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale2" style="font-size:100%;">2</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale_dc'] == '2') {
                                                    ...
                                                    id="rankin_scale_dc2" value="2" name="rankin_scale_dc"
                                                    oninput="rankinScaleDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale_dc2" style="font-size:100%;">2</label>
                                            </div>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="5%">&nbsp;3</td>
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;มีความผิดปกติพอสมควร สามารถทำกิจวัตรประจำวันได้บางอย่าง
                                            เดินได้โดยไม่ต้องมีคนช่วย</td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale'] == '3') {
                                                    ...
                                                    id="rankin_scale3" value="3" name="rankin_scale"
                                                    oninput="rankinScaleCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale3" style="font-size:100%;">3</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale_dc'] == '3') {
                                                    ...
                                                    id="rankin_scale_dc3" value="3" name="rankin_scale_dc"
                                                    oninput="rankinScaleDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale_dc3" style="font-size:100%;">3</label>
                                            </div>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="5%">&nbsp;4</td>
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;มีความผิดปกติมาก
                                            ไม่สามารถทำกิจวัตรประจำวันเองโดยไม่มีคนช่วยได้ เดินได้แต่ต้องพยุง</td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale'] == '4') {
                                                    ...
                                                    id="rankin_scale4" value="4" name="rankin_scale"
                                                    oninput="rankinScaleCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale4" style="font-size:100%;">4</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale_dc'] == '4') {
                                                    ...
                                                    id="rankin_scale_dc4" value="4" name="rankin_scale_dc"
                                                    oninput="rankinScaleDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale_dc4" style="font-size:100%;">4</label>
                                            </div>
                                    ...
                                    <tr style="border:1px solid #000;margin: 45px;">
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="5%">&nbsp;5</td>
                                        <td style="text-align:left; border-right:0.5px solid #000;padding:4px;"
                                            width="10%">&nbsp;มีความผิดปกติรุนแรง ต้องนอนบนเตียง ปัสสาวะราด
                                            ต้องการการดูแลอย่างใกล้ชิด</td>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale'] == '5') {
                                                    ...
                                                    id="rankin_scale5" value="5" name="rankin_scale"
                                                    oninput="rankinScaleCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale5" style="font-size:100%;">5</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale_dc'] == '5') {
                                                    ...
                                                    id="rankin_scale_dc5" value="5" name="rankin_scale_dc"
                                                    oninput="rankinScaleDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale_dc5" style="font-size:100%;">5</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale'] == '6') {
                                                    ...
                                                    id="rankin_scale6" value="6" name="rankin_scale"
                                                    oninput="rankinScaleCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale6" style="font-size:100%;">6</label>
                                            </div>
                                        ...
                                        <td style="text-align:center; border-right:0.5px solid #000;padding:4px;"
                                            ...
                                            <div class="custom-control custom-radio col-sm-1">
                                                <input type="radio" <?php if ($row['rankin_scale_dc'] == '6') {
                                                    ...
                                                    id="rankin_scale_dc6" value="6" name="rankin_scale_dc"
                                                    oninput="rankinScaleDcCheckValue()">
                                                <label class="custom-control-label badge text-red mt-1 font-weight-bold"
                                                    for="rankin_scale_dc6" style="font-size:100%;">6</label>
                                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" id="version" name="version"
                                        value="<?= htmlspecialchars($row['version']) ?>">
                                    ...
                                    <input type="hidden" id="create_datetime" name="create_datetime"
                                        value="<?= htmlspecialchars($row['create_datetime']) ?>">
                                    ...
                                    <div class="col-md-12 text-right">
                                        ...
                                        if (
                                            ...
                                            <button type="button" class="btn btn-primary" id="btn_lr_report1"
                                                onclick="form_save()"><i class="fas fa-save"></i> บันทึก</button>
                                        <?php } ?>
                                        <a href="/pdffile/barthel-pdf.php?an=<?php echo $an; ?>&id=<?= $ids ?>&loginname=<?php echo $loginname; ?>"
                                            target="_blank" class="btn btn-secondary"><i class="fas fa-file-pdf"></i>
                                            Print <U>PDF</U> File</a>
                                    </div>
                                </div>
                            </div>
                        </div>
