    ...
    <div class="col-sm-12">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="pills-document-tab" data-toggle="tab" href="#pills-document" role="tab" aria-controls="pills-document" aria-selected="true">แบบประเมินผู้ป่วยวิกฤตแรกรับตามแนวคิด FANCAS โรงพยาบาลปราสาท</a>
        
            </div> <!-- style="display: none" -->
        </nav>
        <div class="tab-content" id="nav-tabContent">

            <div class="tab-pane fade show active" id="pills-document" role="tabpanel" aria-labelledby="pills-document-tab"><?php require_once 'prs-icu1-document.php';?></div>
