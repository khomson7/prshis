                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control form-control-sm CheckPer_2" placeholder="xxxxxx" name="infected_location" id="infected_location" value="<?= (isset($row['infected_location']) ? htmlspecialchars($row['infected_location']) : '') ?>">
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control form-control-sm CheckPer_2" placeholder="xxxxxx" name="found_pathogens" id="found_pathogens" value="<?= (isset($row['found_pathogens']) ? htmlspecialchars($row['found_pathogens']) : '') ?>">
                                </div>
                                </div>
                                <br>
...
//$('#specimen').empty().trigger('change');
                    ...
                    if(physician_approved != null){
                        ...
                        /*    if (physician_approved == "") {

                                $('[name="physician_approved"]').focus();
                                alert('เลือกแพทย์ผู้อนุมัติสั่งใช้');
                            } else if (rxtime == "") {
