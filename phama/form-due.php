...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-document" role="tabpanel" aria-labelledby="pills-document-tab"><?php require_once 'prs-mental-health3-document.php';?></div>
