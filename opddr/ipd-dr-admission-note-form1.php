<?php  // require_once './project/function/Session.php';
       ...
       // Session::checkPermissionAndShowMessage('IPD_NURSE_ADDMISSION_NOTE','VIEW');
        ...
        if($admission_note_id == null){
            $sql_opdscreen="SELECT opdscreen.hn,opdscreen.cc,opdscreen.hpi,concat(round(opdscreen.bpd,0),'/',round(opdscreen.bps,0)) as bp,
                            ...
                            opdscreen.pe_ext_text, opdscreen.pe
...
<form id="admit_firsth" action=""  method="post"  enctype="multipart/form-data">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-11">
                <h4>แบบบันทึกประวัติและตรวจร่างกายผู้ป่วยแรกรับ <?=htmlspecialchars(DbConstant::HOSPITAL_NAME)?></h4>
            </div>
        </div><p></p>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <label class="col-sm-1"><B> CC: </B></label>
                                <div class="col-sm-11">
                                    <textarea class="form-control" id="" name="chief_complaints" rows="3" ><?=(isset($row_opdscreen['cc']) && $admission_note_id == null ? htmlspecialchars($row_opdscreen['cc']) : htmlspecialchars($row['chief_complaints']))?></textarea>
                                </div>
                            </div>
                            ...
                            <label class="col-sm-1"><B> PI: </B></label>
                                <div class="col-sm-11">
                                    <textarea class="form-control" id="" name="hpi" rows="3" ><?=(isset($row_opdscreen['hpi']) && $admission_note_id == null ? htmlspecialchars($row_opdscreen['hpi']) : htmlspecialchars($row['hpi']))?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="custom-control custom-radio col-sm-9">
                                    ...
                                    <label class="custom-control-label" for="entered_by1">ไม่ได้รับการรักษาจากที่ใด</label>
                                </div>
                                <div class="col-sm-1"></div>
                                ...
                                <input type="radio" <?php if ($row['take_medication_by'] != 'มาเอง'
                                    ...
                                    <label class="custom-control-label" for="entered_by3">ได้รับการรักษา ระบุ</label>
                                </div>
                                <div class="col-sm-6">
                                    <textarea class="form-control" id="entered_hos" name="take_medication_by"
                                            ...
                                            <?php if (!($row['take_medication_by'] != 'มาเอง'
                                                    &&$row['take_medication_by'] != 'แพทย์นัด'
                                                    &&$row['take_medication_by'] != NULL)) {echo 'disabled';} ?>></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="custom-control custom-radio col-sm-2">
                                    <input type="radio" <?php if ($row['take_medication_by'] == 'มาเอง'
                                                                ||$row['take_medication_by'] == NULL)  {echo 'checked="checked"';} ?>
                                        class="custom-control-input" id="entered_by1" name="take_medication_by" value="มาเอง"    onchange="custom_check('off_entered');">
                                    <label class="custom-control-label" for="entered_by1">ไม่พบความผิดปกติ</label>
                                </div>
                                <div class="col-sm-1"></div>
                                ...
                                <input type="radio" <?php if ($row['take_medication_by'] != 'มาเอง'
                                                                ...
                                                                &&$row['take_medication_by'] != NULL)  {echo 'checked="checked"';} ?>
                                        class="custom-control-input" id="entered_by3"    onchange="custom_check('on_entered');">
                                    <label class="custom-control-label" for="entered_by3"></label>
                                </div>
                                <div class="col-sm-6">
                                    <textarea class="form-control" id="entered_hos" name="take_medication_by"
                                            value="<?php if ($row['take_medication_by'] != 'มาเอง'
    ...
    <div class="custom-control custom-radio col-sm-1">
        <input type="radio" <?php if ($row['take_medication_by'] == 'มาเอง'
                                    ||$row['take_medication_by'] == NULL)  {echo 'checked="checked"';} ?>
            class="custom-control-input" id="entered_by1" name="take_medication_by" value="มาเอง"    onchange="custom_check('off_entered');">
        <label class="custom-control-label" for="entered_by1">ผู้ป่วย</label>
    </div>
    <div class="col-sm-1"></div>
    <div class="custom-control custom-radio col-sm-1">
    <input type="radio" <?php if ($row['take_medication_by'] != 'มาเอง'
                                    &&$row['take_medication_by'] != 'แพทย์นัด'
                                    &&$row['take_medication_by'] != NULL)  {echo 'checked="checked"';} ?>
            class="custom-control-input" id="entered_by2"    onchange="custom_check('on_entered');">
        <label class="custom-control-label" for="entered_by2">บิดา / มารดา</label>
    </div>
    <div class="col-sm-1"></div>
    <div class="custom-control custom-radio col-sm-1">
    <input type="radio" <?php if ($row['take_medication_by'] != 'มาเอง'
                                    ...
                                    &&$row['take_medication_by'] != NULL)  {echo 'checked="checked"';} ?>
            class="custom-control-input" id="entered_by3"    onchange="custom_check('on_entered');">
        <label class="custom-control-label" for="entered_by3"> อื่นๆ ระบุ</label>
    </div>
    <div class="col-sm-6">
        <textarea class="form-control" id="entered_hos" name="take_medication_by"
                value="<?php if ($row['take_medication_by'] != 'มาเอง'
                            ...
                            <div class="form-group row">
                                ...
                                <div class="custom-control custom-radio col-sm-2">
                                    <input type="radio" <?php if ($row['take_medication_by'] == 'มาเอง'
                                                                ||$row['take_medication_by'] == NULL)  {echo 'checked="checked"';} ?>
                                        class="custom-control-input" id="entered_by1" name="take_medication_by" value="มาเอง"    onchange="custom_check('off_entered');">
                                    <label class="custom-control-label" for="entered_by1">Complete</label>
                                </div>
                                <div class="col-sm-1"></div>
                                <div class="custom-control custom-radio col-sm-1">
                                <input type="radio" <?php if ($row['take_medication_by'] != 'มาเอง'
...
<div class="form-group row">
    ...
    <div class="custom-control custom-radio col-sm-2">
        <input type="radio" <?php if ($row['take_medication_by'] == 'มาเอง'
                                    ||$row['take_medication_by'] == NULL)  {echo 'checked="checked"';} ?>
            class="custom-control-input" id="entered_by1" name="take_medication_by" value="มาเอง"    onchange="custom_check('off_entered');">
        <label class="custom-control-label" for="entered_by1">No</label>
    </div>
    <div class="col-sm-1"></div>
    <div class="custom-control custom-radio col-sm-1">
    <input type="radio" <?php if ($row['take_medication_by'] != 'มาเอง'
    ...
    <div class="col-sm-6">
        ...
        <div class="patient-info-container alert alert-secondary" role="alert" style="z-index: 600;">
            <div class="d-flex">
                ...
                BP: &nbsp;<input type="text" class="form-control" id="" name="bp" disabled value="<?=(isset($row_vs['sbp']) ? htmlspecialchars($row_vs['sbp']).'/' : '')?><?=(isset($row_vs['dbp']) ? htmlspecialchars($row_vs['dbp']) : '')?>"
                        ...
                        <div class="col-sm-3">                           
                              <div class="input-group input-group-sm sm-1">
                PR: &nbsp;<input type="text" class="form-control" id="" name="pr"  disabled value="<?=(isset($row_vs['pr']) ? htmlspecialchars($row_vs['pr']) : '')?>" aria-describedby="inputGroup-sizing-sm">
                                        <div class="input-group-append">
                           ...
                           <div class="col-sm-3">                           
                              <div class="input-group input-group-sm sm-1">
                RR: &nbsp; <input type="text" class="form-control" id="" name="rr"   disabled value="<?=(isset($row_vs['rr']) ? htmlspecialchars($row_vs['rr']) : '')?>" aria-describedby="inputGroup-sizing-sm">
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="inputGroup-sizing-sm"> /min  </span>
                                        </div>
                              </div>
                           ...
                           <div class="col-sm-3">                           
                              <div class="input-group input-group-sm sm-1">
                BT: &nbsp; <input type="text" class="form-control" id="" name="t" disabled value="<?=(isset($row_vs['bt']) ? htmlspecialchars($row_vs['bt']) : '')?>"
                                                aria-describedby="inputGroup-sizing-sm">
                                        <div class="input-group-append">
...
<div class="row">    
                       <div class="col-sm-3">
                <div class="input-group input-group-sm sm-1">
                น้ำหนัก: &nbsp; <input type="text" class="form-control" id="" name=""  disabled value="<?=(isset($row_ipt['latest_bw']) ? htmlspecialchars($row_ipt['latest_bw']) : '')?>" aria-describedby="inputGroup-sizing-sm">
                                  <div class="input-group-append">
                        ...
                        <div class="col-sm-3">                           
                              <div class="input-group input-group-sm sm-1">
                ส่วนสูง: &nbsp;<input type="text" class="form-control" id="" name=""  disabled value="<?=(isset($row_ipt['latest_height']) ? htmlspecialchars($row_ipt['latest_height']) : '')?>" aria-describedby="inputGroup-sizing-sm">
                                        <div class="input-group-append">
