                                ...
                                <div class="card-body" style=" overflow-y: auto;">
                                        ...
                                        <div class="row">
                                                ...
                                                <div>
                                                        ...
                                                        <input type="text" class="form-control form-control-sm CheckPer_2" placeholder="เฉพาะตัวเลข" name="bun_lab" id="bun_lab" value="<?= (isset($row_opdscreen['age_y'])  ? htmlspecialchars(round(($row_opdscreen['age_y']), 1)) : htmlspecialchars(round(($row['age_y']), 1))) ?>" readonly>
                                                </div> &nbsp;ปี&nbsp; น้ำหนักจริง (ABW) (kg) :&nbsp;<div>
                                                        <input type="text" class="form-control form-control-sm CheckPer_2" placeholder="เฉพาะตัวเลข" name="creatinine" id="creatinine" value="<?= (isset($row_opdscreen['bw'])  ? htmlspecialchars(round(($row_opdscreen['bw']), 1)) : htmlspecialchars(round(($row['bw']), 1))) ?>" readonly>
                                                </div>&nbsp;Kg&nbsp;
                                        </div>
                                        <br>
                                                                        ...
                                                                        <td style="text-align:left; border: 0.5px solid #000; padding: 4px;" width="1%">
                                                                                <div class="custom-control custom-radio">
                                                                                        <input type="radio"
                                                                                                ...
                                                                                                name="best_moter_left_leg"
                                                                                                value="1"
                                                                                                <?php if ($row['sbest_moter_left_leg'] == '1') echo 'checked="checked"'; ?> oninput="oninputCheckValue()">
                                                                ...
                                                                <tr style="border:1px solid #000;margin: 45px;">
                                                                        ...
                                                                        <td style="text-align:left; border: 0.5px solid #000; padding: 4px;" width="1%">
                                                                                <div class="custom-control custom-radio">
                                                                                        ...
                                                                                        <label class="custom-control-label" for="ssensory1" style="display:inline-block; width: 250px;">
                        ...
                        <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label" for="neglect2" style="display:inline-block; width: 250px;">
                                        2 - Complete neglect ไม่สนสิ่งกระตุ้นทั้งหมด
                                                ...
                                                <div class="alert alert-success text-center col-sm-12" role="alert"><b>✅ Indications for IV thrombolysis ( must be all "Yes" )</b></div>
