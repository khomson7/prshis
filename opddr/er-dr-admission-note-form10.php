                ...
                <div class="card border-success">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <button type="button" class="btn btn-secondary btn-sm PhysicalExaminationBtn" onclick="onclick_Normal('pe_skin','No abnormal lesion')"><i class="fas fa-user"></i> Normal</button>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <button type="button" class="btn btn-secondary btn-sm PhysicalExaminationBtn" onclick="onclick_Normal('pe_heent','Not pale no jaungice Normal Pharynx toalsils and thyroid LN')"><i class="fas fa-user"></i> Normal</button>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <button type="button" class="btn btn-secondary btn-sm PhysicalExaminationBtn" onclick="onclick_Normal('pe_lungs','Normal chest movement Normal breast sounds Lt=Rt')"><i class="fas fa-user"></i> Normal</button>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <button type="button" class="btn btn-secondary btn-sm PhysicalExaminationBtn" onclick="onclick_Normal('pe_abdomen','Normoactive bowel sounds Soft not tender Liver and spleen not palpabled No abnormal mass CVA not tender')"><i class="fas fa-user"></i> Normal</button>
