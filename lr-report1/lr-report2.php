...
$sql = "SELECT count(*) AS count_row, id FROM " . DbConstant::KPHIS_DBNAME . ".prs_labor_report2 WHERE an = :an ";
$id  = null;
$parameters['an'] = $an;
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-auto p-1 font-weight-bold">
                ข้อมูลแบบแผนสุขภาพ (Functional Health Pattern) <?= htmlspecialchars(DbConstant::HOSPITAL_NAME) ?>
            </div>
        ...
        <div class="card-group pb-3 ">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <label class="col-sm-2 text-left">1. การรับรู้และการดูแลสุขภาพ ซักถามจาก</label>
                                ...
                                <div class="custom-control custom-checkbox col-sm-1">
                                    ...
                                    <label class="custom-control-label" for="e3">บิดา/มารดา</label>
                                </div>
                                <div class="custom-control custom-checkbox col-sm-1">
                                    <input type="checkbox" <?php if ($row['informant_deliverer'] == 'ผู้นำส่ง') {
                                                                echo 'checked="checked"';
                                                            } ?> class="custom-control-input" id="e3" value="ผู้นำส่ง" name="informant_deliverer">
                                    <label class="custom-control-label" for="e3">สามี/ภรรยา</label>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="custom-control custom-checkbox col-sm-2">
                                        ...
                                        <label class="custom-control-label" for="e4">ญาต/อื่นๆ</label>
                                    </div>
                                    <div class="col-sm-9">
                            ...
                            <div class="row">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<label>สุขภาพก่อนการเจ็บป่วย</label>
                                <div class="custom-control custom-radio col-sm-1">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ดี') {
                                                                                    echo 'checked="checked"';
                                                                                } ?> class="custom-control-input" id="body1" name="body" value="ดี" onchange="body_check('off_entered');">
                                    <label class="custom-control-label" for="body1">ดี</label>
                                </div>

                                <div class="custom-control custom-radio col-sm-1">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] != 'ไม่ดี' && $row['body'] != NULL) {
                                                                                    echo 'checked="checked"';
                                                                                } ?> class="custom-control-input" id="body2" onchange="body_check('on_entered');">
                                    <label class="custom-control-label" for="body2">ไม่ดี ระบุ</label>
                                </div>

                                <div class="col-sm-5">
                                    <input type="text" class="form-control form-control-sm" id="body_text" name="body" value="<?php if ($row['body'] != 'ดี' && $row['body'] != NULL) {
                                                                                                                                    echo htmlspecialchars($row['body']);
                                                                                                                                } ?>" <?php if (!($row['body'] != 'ดี' && $row['body'] != NULL)) {
                                                                                                                                            echo 'disabled';
                                                                                                                                        } ?>>
                                </div>
                            ...
                            <div class="row">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<label>การดูแลสุขภาพเมื่อเจ็บป่วย</label>
                                <div class="custom-control custom-radio col-sm-2">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ดี') {
                                                                                    echo 'checked="checked"';
                                                                                } ?> class="custom-control-input" id="body1" name="body" value="ดี" onchange="body_check('off_entered');">
                                    <label class="custom-control-label" for="body1">ไป รพ./สถานีอนามัย</label>
                                </div>
                                ...
                                <div class="custom-control custom-radio col-sm-2">
                                    ...
                                    <label class="custom-control-label" for="body1">ซื้อยารับประทานเอง</label>
                                </div>
                            ...
                            <br>
                            <div class="row">
                                <label class="col-sm-2 text-left">ความคาดหวังเมื่อเข้ารับการรักษาในครั้งนี้</label>
                                <div class="custom-control custom-radio col-sm-1">
                                    <input type="radio" class="custom-control-input" id="anuss1" value="คิดว่าหาย" name="anuss">
                                    <label class="custom-control-label" for="anuss1">คิดว่าหาย</label>
                                </div>
                                <div class="custom-control custom-radio col-sm-1">
                                    <input type="radio" class="custom-control-input" id="anuss2" value="ไม่แน่ใจ" name="anuss">
                                    <label class="custom-control-label" for="anuss2">ไม่แน่ใจ</label>
                                </div>
                                <div class="custom-control custom-radio col-sm-1">
                                    <input type="radio" class="custom-control-input" id="anuss2" value="ไม่หาย" name="anuss">
                                    <label class="custom-control-label" for="anuss2">ไม่หาย</label>
                                </div>
                            ...
                            <div class="row">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<label>การใช้สิ่งเสพติด</label>
                                <div class="custom-control custom-radio col-sm-">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ไม่เคย') {
                                                                                    echo 'checked="checked"';
                                                                                } ?> class="custom-control-input" id="body1" name="body" value="ไม่เคย" onchange="body_check('off_entered');">
                                    <label class="custom-control-label" for="body1">ไม่เคย</label>
                                </div>

                                <div class="custom-control custom-radio col-sm-1">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'เคย') {
                                                                                    echo 'checked="checked"';
                                                                                } ?> class="custom-control-input" id="body1" name="body" value="เคย" onchange="body_check('off_entered');">
                                    <label class="custom-control-label" for="body1">เคย</label>
            ...
            echo 'disabled';
                                ...
                                &nbsp;<label>มวน/วัน</label>&nbsp;&nbsp;&nbsp;&nbsp;<label>เป็นเวลา</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control form-control-sm" id="body_text" name="body" value="<?php if ($row['body'] != 'ดี' && $row['body'] != NULL) {
                                                                                                                                    echo htmlspecialchars($row['body']);
                                                                                                                                } ?>" <?php if (!($row['body'] != 'ดี' && $row['body'] != NULL)) {
            echo 'disabled';
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="body1">ดื่มสุรา</label>
            ...
            echo 'disabled';
                            ...
                            <div class="row">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="body1">ปัจจุบันเลิกเสพ</label>
            ...
            echo 'disabled';
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="body1">ปัจจุบันยังไม่เลิกเสพ</label>
            ...
            echo 'disabled';
                            ...
                            <div class="row">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<label>การเสพสิ่งเสพติดของบุคคลในครอบครัว</label>
                                <div class="custom-control custom-radio col-sm-1">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ดี') {
                                                                                    echo 'checked="checked"';
                                                                                } ?> class="custom-control-input" id="body1" name="body" value="ดี" onchange="body_check('off_entered');">
                            ...
                            <div class="row">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<label>2. ภาวะโภชนาการและเมตาบอลิซึม&nbsp; น้ำหนัก&nbsp;</label>
                                <div class="col-md-1">
                                    <input type="text" class="form-control form-control-sm CheckPer_2" placeholder="" name="g" id="g">
                                </div>&nbsp; กิโลกรัม&nbsp;&nbsp;ส่วนสูง
                                <div class="col-md-1">
                                    <input type="text" class="form-control form-control-sm CheckPer_2" placeholder="" name="p" id="p">
                                </div> &nbsp;<label> เซนติเมตร&nbsp;&nbsp;</label>

                            </div>
                            <br>
                            <div class="row">

                                &nbsp;&nbsp;&nbsp;&nbsp;<label>น้ำหนักก่อนตั้งครรภ์&nbsp;&nbsp;</label>
                                <div class="col-md-1">
                                    <input type="text" class="form-control form-control-sm CheckPer_2" placeholder="" name="g" id="g">
                                </div>&nbsp; กิโลกรัม&nbsp;&nbsp;BMI&nbsp;ก่อนการตั้งครรภ์
                                <div class="col-md-1">
                                    <input type="text" class="form-control form-control-sm CheckPer_2" placeholder="" name="p" id="p">
                                </div> &nbsp;<label> กิโลกรัมต่อตารางเมตร&nbsp;&nbsp;น้ำหนักเพิ่มขึ้น</label>
                                <div class="col-md-1">
                                    <input type="text" class="form-control form-control-sm CheckPer_2" placeholder="" name="g" id="g">
                                </div>&nbsp; กิโลกรัม
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <input type="text" class="form-control form-control-sm CheckPer_2" placeholder="" name="g" id="g">
                                </div>&nbsp; มื้อต่อวัน&nbsp;&nbsp;พฤติกรรมการรับประทานอาหาร
                                <div class="col-md-2">
                                    <input type="text" class="form-control form-control-sm CheckPer_2" placeholder="" name="p" id="p">
                                </div> &nbsp;<label> ดื่มน้ำ&nbsp;</label>
                                <div class="col-md-1">
                                    <input type="text" class="form-control form-control-sm CheckPer_2" placeholder="" name="g" id="g">
                                </div>&nbsp; แก้วต่อวัน
                            ...
                            <div class="row">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<label>ปัญหาการรับประทานอาหารก่อนการเจ็บป่วยครั้งนี้</label>
                                <div class="custom-control custom-radio col-sm-1">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ดี') {
                                                                                    echo 'checked="checked"';
                                                                                } ?> class="custom-control-input" id="body1" name="body" value="ดี" onchange="body_check('off_entered');">
                            ...
                            <div class="row">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<label>3.&nbsp;การขับถ่าย&nbsp;การขับถ่ายปัสสาวะ</label>
                                <div class="custom-control custom-radio col-sm-1">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ดี') {
                                                                                    echo 'checked="checked"';
                                                                                } ?> class="custom-control-input" id="body1" name="body" value="ดี" onchange="body_check('off_entered');">
                                ...
                                <div class="custom-control custom-radio col-sm-1">
                                    ...
                                    <label class="custom-control-label" for="body2">ไม่ปกติ ระบุ</label>
                                </div>
                            ...
                            <div class="row">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<label>4.&nbsp;กิจกรรมและการออกำลังกาย&nbsp;ความสามารถในการทำกิจวัตรประจำวัน</label>
                                <div class="custom-control custom-radio col-sm-2">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ดี') {
                                                                                    echo 'checked="checked"';
                                                                                } ?> class="custom-control-input" id="body1" name="body" value="ดี" onchange="body_check('off_entered');">
                                ...
                                <div class="custom-control custom-radio col-sm-2">
                                    ...
                                    <label class="custom-control-label" for="body2">ช่วยเหลือตัวเองไม่ได้</label>
                                </div>


                                <div class="col-sm-10">
                                    เนื่องจาก<input type="text" class="form-control form-control-sm" id="body_text" name="body" value="<?php if ($row['body'] != 'ดี' && $row['body'] != NULL) {
                                                                                                                                            echo htmlspecialchars($row['body']);
                                                                                                                                        } ?>" <?php if (!($row['body'] != 'ดี' && $row['body'] != NULL)) {
                                                                                                            echo 'disabled';
                                                                                                        } ?>>
                            ...
                            <div class="row">
                                <label class="col-sm-1 text-left">การออกกำลังกาย</label>
                                <div class="custom-control custom-radio col-sm-1">
                                    <input type="radio" class="custom-control-input" id="anuss1" value="คิดว่าหาย" name="anuss">
                                    <label class="custom-control-label" for="anuss1">สม่ำเสมอ</label>
                                </div>
                                <div class="custom-control custom-radio col-sm-1">
                                    <input type="radio" class="custom-control-input" id="anuss2" value="ไม่แน่ใจ" name="anuss">
                                    <label class="custom-control-label" for="anuss2">นานๆครั้ง</label>
                                </div>
                                <div class="custom-control custom-radio col-sm-1">
                                    <input type="radio" class="custom-control-input" id="anuss2" value="ไม่หาย" name="anuss">
                                    <label class="custom-control-label" for="anuss2">ไม่เคย</label>
                                </div>
                            ...
                            <hr>
                            <div class="row">
                                &nbsp;&nbsp;&nbsp;&nbsp;<label>5.&nbsp;การนอนหลับพักผ่อน</label>
                                <br>

                            </div>

                            <div class="row">
                                &nbsp;&nbsp;&nbsp;&nbsp;<label>อุปนิสัยในการนอนหลับ&nbsp;&nbsp;ปกตินอนวันละ</label>
                                <div class="col-md-1">
                                    <input type="text" class="form-control form-control-sm CheckPer_2" placeholder="" name="g" id="g">
                                </div>&nbsp;ชั่วโมง&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <div class="custom-control custom-radio col-sm-1">
                                    <input type="radio" class="custom-control-input" id="anuss1" value="คิดว่าหาย" name="anuss">
                                    <label class="custom-control-label" for="anuss1">เพียงพอ</label>
                                </div>
                                <div class="custom-control custom-radio col-sm-1">
                                    <input type="radio" class="custom-control-input" id="anuss2" value="ไม่แน่ใจ" name="anuss">
                                    <label class="custom-control-label" for="anuss2">ไม่เพียงพอ</label>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="custom-control custom-radio col-sm-2">
                                    ...
                                    <label class="custom-control-label" for="body1">ใช้ประจำ</label>
                                </div>
                                ...
                                <div class="custom-control custom-radio col-sm-2">
                                    ...
                                    <label class="custom-control-label" for="body2">ใช้เป็นบางครั้ง&nbsp;ระบุ</label>
                                </div>
                            ...
                            <div class="row">
                                &nbsp;&nbsp;&nbsp;&nbsp;<label>6.&nbsp;การรับรู้ตนเองและมโนทัศน์</label>
                                <br>

                            </div>

                            <div class="row">
                                <label class="col-sm-2 text-left">การเจ็บป่วยครั้งนี้มีผลกระทบต่อ</label>
                                <div class="custom-control custom-radio col-sm-1">
                                    <input type="radio" class="custom-control-input" id="anuss1" value="คิดว่าหาย" name="anuss">
                                    <label class="custom-control-label" for="anuss1">ภาพลักษณ์</label>
                                </div>
                                <div class="custom-control custom-radio col-sm-1">
                                    <input type="radio" class="custom-control-input" id="anuss2" value="ไม่แน่ใจ" name="anuss">
                                    <label class="custom-control-label" for="anuss2">อารมณ์และจิตใจ</label>
                                </div>
                                <div class="custom-control custom-radio col-sm-2">
                                    <input type="radio" class="custom-control-input" id="anuss2" value="ไม่หาย" name="anuss">
                                    <label class="custom-control-label" for="anuss2">ความสามารถในการใช้ชีวิตประจำวัน</label>
                                </div>
                            ...
                            <div class="row">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<label>สิ่งที่ทำให้เกิดความเครียด / ไม่สบายใจในปัจจุบัน</label>
                                <div class="custom-control custom-radio col-sm-1">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ดี') {
                                                                                    echo 'checked="checked"';
                                                                                } ?> class="custom-control-input" id="body1" name="body" value="ดี" onchange="body_check('off_entered');">
                            ...
                            <div class="row">
                                &nbsp;&nbsp;&nbsp;&nbsp;<label>7.&nbsp;เพศสัมพันธ์และการเจริญพันธ์</label>
                                <br>

                            </div>
                            <div class="row">

                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>7.1 ประวัติการมีเพศสัมพันธ์</label>
                                <div class="custom-control custom-radio col-sm-2">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ดี') {
                                                                                                            echo 'checked="checked"';
                                                                                                        } ?> class="custom-control-input" id="body1" name="body" value="ดี" onchange="body_check('off_entered');">
                                    <label class="custom-control-label" for="body1">ยังไม่เคยมีเพศสัมพันธ์</label>
                                </div>
                                ...
                                <div class="custom-control custom-radio col-sm-1">
                                    ...
                                    <label class="custom-control-label" for="body1">ไม่มีปัญหา</label>
                                </div>
                                ...
                                <div class="custom-control custom-radio col-sm-2">
                                    ...
                                    <label class="custom-control-label" for="body2">มีปัญหา&nbsp;ระบุ</label>
                                </div>
                            ...
                            <div class="row">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>7.2 ประวัติพฤติกรรมเสี่ยงต่อการติดเชื้อโรคติดต่อทางเพศสัมพันธ์ 5 ข้อ (เฉพาะอายุ 14-49 ปี)</label>
                            </div>
...
<div class="custom-control custom-checkbox col-sm-2">
    ...
    <label class="custom-control-label" for="e1">คู่เพศสัมพันธ์เป็นโรคติดต่อทางเพศสัมพันธ์</label>
</div>
<div class="custom-control custom-checkbox col-sm-2">
    <input type="checkbox" <?php if ($row['informant_deliverer'] == 'ผู้นำส่ง') {
                                echo 'checked="checked"';
                            } ?> class="custom-control-input" id="e3" value="ผู้นำส่ง" name="informant_deliverer">
    <label class="custom-control-label" for="e3">มีเพศสัมพันธ์กับชาย/หญิงให้บริการไม่ใช้ถุงยาง</label>
</div>
<div class="custom-control custom-checkbox col-sm-2">
    <input type="checkbox" <?php if ($row['informant_deliverer'] == 'ผู้นำส่ง') {
                                echo 'checked="checked"';
                            } ?> class="custom-control-input" id="e3" value="ผู้นำส่ง" name="informant_deliverer">
    <label class="custom-control-label" for="e3">มีเพศสัมพันธ์มากกว่า1คน</label>
</div>
<div class="custom-control custom-checkbox col-sm-2">
    <input type="checkbox" <?php if ($row['informant_deliverer'] == 'ผู้นำส่ง') {
                                echo 'checked="checked"';
                            } ?> class="custom-control-input" id="e3" value="ผู้นำส่ง" name="informant_deliverer">
    <label class="custom-control-label" for="e3">มีเพศสัมพันธ์กับคนใหม่</label>
</div>
...
<div class="custom-control custom-checkbox col-sm-2">
    ...
    <label class="custom-control-label" for="e3">ไม่ใช้ถุงยางอนามัยหรือแตก รั่ว หลุด</label>
</div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>7.3 ประวัติการตรวจ HIV&nbsp;</label>
                                <div class="custom-control custom-radio col-sm-">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ไม่เคย') {
                                                                                    echo 'checked="checked"';
                                                                                } ?> class="custom-control-input" id="body1" name="body" value="ไม่เคย" onchange="body_check('off_entered');">
            ...
            echo 'disabled';
                                ...
                                &nbsp;<label>ครั้ง</label>&nbsp;&nbsp;&nbsp;&nbsp;<label>ผลการตรวจ</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control form-control-sm" id="body_text" name="body" value="<?php if ($row['body'] != 'ดี' && $row['body'] != NULL) {
                                                                                                                                    echo htmlspecialchars($row['body']);
                                                                                                                                } ?>" <?php if (!($row['body'] != 'ดี' && $row['body'] != NULL)) {
            echo 'disabled';
                                ...
                                &nbsp;<label>ครั้งสุดท้ายวันที่</label>
                                <div class="col-sm-2">
...
<br>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>7.4 ประวัติประจำเดือน</label>
<div class="custom-control custom-radio col-sm-2">
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ดี') {
                                                    echo 'checked="checked"';
                                                } ?> class="custom-control-input" id="body1" name="body" value="ดี" onchange="body_check('off_entered');">
    <label class="custom-control-label" for="body1">ยังไม่มีประจำเดือน</label>
</div>
...
<div class="custom-control custom-radio col-sm-2">
    ...
    <label class="custom-control-label" for="body1">หมดประจำเดือน</label>
</div>
<div class="custom-control custom-radio col-sm-1">
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ดี') {
                                                    echo 'checked="checked"';
...
<div class="custom-control custom-radio col-sm-1">
    ...
    <label class="custom-control-label" for="body2">ผิดปกติ ระบุ</label>
</div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>7.5 เต้านม/หัวนม (เฉพาะหญิงตั้งครรภ์)</label>
<div class="custom-control custom-radio col-sm-1">
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ดี') {
                                                    echo 'checked="checked"';
                                                } ?> class="custom-control-input" id="body1" name="body" value="ดี" onchange="body_check('off_entered');">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>7.6 ประวัติตกขาว คันช่องคลอด</label>
<div class="custom-control custom-radio col-sm-1">
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ดี') {
                                                    echo 'checked="checked"';
                                                } ?> class="custom-control-input" id="body1" name="body" value="ดี" onchange="body_check('off_entered');">
