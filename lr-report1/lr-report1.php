                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="custom-control custom-radio col-sm-5">
                                  <label>จาก</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['receive_from'] == 'คลอดในโรงพยาบาล'
                                ||$row['receive_from'] == NULL)  {echo 'checked="checked"';} ?>
                                      class="custom-control-input" id="receive_from1" name="receive_from" value="คลอดในโรงพยาบาล"
                                      onchange="custom_check('off_entered');">
                               ...
                               <br>
                                ...
                                &nbsp;<div class="custom-control custom-radio col-sm-2">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" <?php if ($row['receive_from'] != 'คลอดในโรงพยาบาล' && $row['receive_from'] != NULL)  {echo 'checked="checked"';} ?>
                                ...
                                <div class="col-sm-5">
                                 <input type="text" class="form-control form-control-sm" id="from_text" name="receive_from"
                                            value="<?php if ($row['receive_from'] != 'คลอดในโรงพยาบาล' && $row['receive_from'] != NULL) {echo htmlspecialchars($row['receive_from']);}?>"
...
<br>
  ...
  <input type="text" class="form-control form-control-sm CheckPer_2"
  placeholder="xxxxxxxxxxx"
   name="antepartum" id="antepartum">
 </div> &nbsp;<label>ประวัติวัคซีน dt มารดา</label>
  <div class="col-md-1"><input type="text" class="form-control form-control-sm CheckPer_2"
  placeholder="0" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"
  name="dt_vaccine" id="dt_vaccine"> </div><label> เข็ม</label>
    </div>
    <br>
    <div class="form-group row">
    ...
    <div class="row">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;<label>สัญญาณชีพ BT</label>
          <div class="col-md-1">
  <input type="text" class="form-control form-control-sm CheckPer_2"
placeholder="0.0" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"
   name="bt" id="bt">
</div> &nbsp;<label>C &nbsp;HR</label>
  <div class="col-md-1"><input type="text" class="form-control form-control-sm CheckPer_2"
placeholder="0" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"
 name="hr" id="hr"> </div><label>bpm &nbsp;RR</label>
 <div class="col-md-1"><input type="text" class="form-control form-control-sm CheckPer_2"
placeholder="0" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"
name="rr" id="rr"> </div>/min
    </div>
<br>
    <div class="row">
...
placeholder="0.0" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"
  ...
  <div class="col-md-1"><input type="text" class="form-control form-control-sm CheckPer_2"
placeholder="0" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"
 name="om" id="om"> </div><label>Cms, รอบอก</label>
 <div class="col-md-1"><input type="text" class="form-control form-control-sm CheckPer_2"
placeholder="0" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"
name="chest" id="chest"> </div><label>cms  ตัวยาว</label>
<div class="col-md-1"><input type="text" class="form-control form-control-sm CheckPer_2"
placeholder="0" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"
name="body_long" id="body_long"> </div><label>cms  Cord</label>
<div class="col-md-1"><input type="text" class="form-control form-control-sm CheckPer_2"
placeholder="0" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"
name="cord" id="cord"> </div><label> Anus</label>
<div class="col-md-1"><input type="text" class="form-control form-control-sm CheckPer_2"
placeholder="0" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"
name="anus" id="anus"> </div>
    </div>
<br>
    <div class="row">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;<label>รูปร่างทั่วไป</label>
          <div class="custom-control custom-radio col-sm-1">
            &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] == 'ปกติ')  {echo 'checked="checked"';} ?>
                      class="custom-control-input" id="body1" name="body" value="ปกติ"
                      onchange="body_check('off_entered');">
                       <label class="custom-control-label" for="body1">ปกติ</label>
  </div>

  <div class="custom-control custom-radio col-sm-1">
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['body'] != 'ปกติ' && $row['body'] != NULL)  {echo 'checked="checked"';} ?>
...
<div class="col-sm-5">
 <input type="text" class="form-control form-control-sm" id="body_text" name="body"
            value="<?php if ($row['body'] != 'ปกติ' && $row['body'] != NULL) {echo htmlspecialchars($row['body']);}?>"
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;<label>การร้อง</label>
          <div class="custom-control custom-radio col-sm-1">
            &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['cry'] == 'ไม่ร้อง')  {echo 'checked="checked"';} ?>
                      class="custom-control-input" id="cry1" name="cry" value="ไม่ร้อง"
                      onchange="cry_check('off_cry');">
                       <label class="custom-control-label" for="cry1">ไม่ร้อง</label>
  </div>
  <div class="custom-control custom-radio col-sm-1">
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['cry'] == 'ร้องเสียงดัง')  {echo 'checked="checked"';} ?>
              class="custom-control-input" id="cry2" name="cry" value="ร้องเสียงดัง"
              onchange="cry_check('off_cry');">
               <label class="custom-control-label" for="cry2">ร้องเสียงดัง</label>
</div>

<div class="custom-control custom-radio col-sm-1">
    <input type="radio" <?php if ($row['cry'] !='ไม่ร้อง'
                                &&$row['cry'] !='ร้องเสียงดัง'
                                &&$row['cry'] != NULL) {echo 'checked="checked"';} ?>
        class="custom-control-input" id="cry3" onchange="cry_check('on_cry');">
    <label class="custom-control-label" for="cry3">ร้องผิดปกติ</label>
</div>

<div class="col-sm-5">
    <input type="text" class="form-control form-control-sm" id="cry_text" name="cry"
        value="<?php if ($row['cry'] !='ไม่ร้อง'
                        &&$row['cry'] !='ร้องเสียงดัง') {echo htmlspecialchars($row['cry']);}?>"
        <?php if (!($row['cry'] !='ไม่ร้อง'
                        &&$row['cry'] !='ร้องเสียงดัง'
                        &&$row['cry'] != NULL)) {echo 'disabled';}?>
    >
</div>
...
<br>
    <div class="row">
      &nbsp;&nbsp;&nbsp;&nbsp;<label>การเคลื่อนไหว</label>
          <div class="custom-control custom-radio col-sm-1">
            &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['movement'] == 'ขยับได้')  {echo 'checked="checked"';} ?>
                      class="custom-control-input" id="movement1" name="movement" value="ขยับได้"
                      onchange="movement_check('off_checked');">
                       <label class="custom-control-label" for="movement1">ขยับได้</label>
  </div>
  <div class="custom-control custom-radio col-sm-1">
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['movement'] == 'อ่อนปวกเปียก')  {echo 'checked="checked"';} ?>
              class="custom-control-input" id="movement2" name="movement" value="อ่อนปวกเปียก"
              onchange="movement_check('off_checked');">
               <label class="custom-control-label" for="movement2">อ่อนปวกเปียก</label>
</div>

<div class="custom-control custom-radio col-sm-1">
  &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['movement'] == 'ชักเกร็ง')  {echo 'checked="checked"';} ?>
            class="custom-control-input" id="movement3" name="movement" value="ชักเกร็ง"
            onchange="movement_check('off_checked');">
...
<div class="custom-control custom-radio col-sm-1">
    <input type="radio" <?php if ($row['movement'] !='ขยับได้'
                                ...
                                &&$row['movement'] != NULL) {echo 'checked="checked"';} ?>
        class="custom-control-input" id="movement4" onchange="movement_check('on_checked');">
    <label class="custom-control-label" for="movement4">ผิดปกติิ</label>
</div>

<div class="col-sm-5">
    <input type="text" class="form-control form-control-sm" id="movement_text" name="movement"
        value="<?php if ($row['movement'] !='ขยับได้'
                                    &&$row['movement'] !='อ่อนปวกเปียก'
                                    &&$row['movement'] !='ชักเกร็ง') {echo htmlspecialchars($row['movement']);}?>"
        <?php if (!($row['movement'] !='ขยับได้'
                                    &&$row['movement'] !='อ่อนปวกเปียก'
                                    &&$row['movement'] !='ชักเกร็ง'
                                    &&$row['movement'] != NULL)) {echo 'disabled';}?>
    >
</div>
    ...
    <br>
        <div class="row">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;<label>ศรีษะ</label>
              <div class="custom-control custom-radio col-sm-1">
                &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['head'] == 'ปกติ')  {echo 'checked="checked"';} ?>
                          class="custom-control-input" id="head1" name="head" value="ปกติ"
                          onchange="head_check('off_checked');">
                           <label class="custom-control-label" for="head1">ปกติ</label>
      </div>

      <div class="custom-control custom-radio col-sm-1">
        &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['head'] != 'ปกติ' && $row['head'] != NULL)  {echo 'checked="checked"';} ?>
    ...
    <div class="col-sm-5">
     <input type="text" class="form-control form-control-sm" id="head_text" name="head"
                value="<?php if ($row['head'] != 'ปกติ' && $row['head'] != NULL) {echo htmlspecialchars($row['head']);}?>"
        ...
        <br>
            <div class="row">
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;<label>ตา</label>
                  <div class="custom-control custom-radio col-sm-1">
                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['eyes'] == 'ปกติ')  {echo 'checked="checked"';} ?>
                              class="custom-control-input" id="eyes1" name="eyes" value="ปกติ"
                              onchange="eyes_check('off_checked');">
                               <label class="custom-control-label" for="eyes1">ปกติ</label>
          </div>

          <div class="custom-control custom-radio col-sm-1">
            &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['eyes'] != 'ปกติ' && $row['eyes'] != NULL)  {echo 'checked="checked"';} ?>
        ...
        <div class="col-sm-5">
         <input type="text" class="form-control form-control-sm" id="eyes_text" name="eyes"
                    value="<?php if ($row['eyes'] != 'ปกติ' && $row['eyes'] != NULL) {echo htmlspecialchars($row['eyes']);}?>"
            ...
            <br>
                <div class="row">
                  &nbsp;&nbsp;&nbsp;&nbsp;<label>จมูก</label>
                      <div class="custom-control custom-radio col-sm-1">
                        &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['nose'] == 'มีรูจมูก 2 ข้าง')  {echo 'checked="checked"';} ?>
                                  class="custom-control-input" id="nose1" name="nose" value="มีรูจมูก 2 ข้าง"
                                  onchange="nose_check('off_checked');">
                                   <label class="custom-control-label" for="nose1">มีรูจมูก 2 ข้าง</label>
              </div>
              <div class="custom-control custom-radio col-sm-1">
                &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['nose'] == 'รูจมูกตัน')  {echo 'checked="checked"';} ?>
                          class="custom-control-input" id="nose2" name="nose" value="รูจมูกตัน"
                          onchange="nose_check('off_checked');">
            ...
            <div class="custom-control custom-radio col-sm-1">
                <input type="radio" <?php if ($row['nose'] !='มีรูจมูก 2 ข้าง'
                                            &&$row['nose'] !='รูจมูกตัน'
                                            &&$row['nose'] != NULL) {echo 'checked="checked"';} ?>
                    class="custom-control-input" id="nose3" onchange="nose_check('on_checked');">
                <label class="custom-control-label" for="nose3">ผิดปกติิ</label>
            </div>

            <div class="col-sm-5">
                <input type="text" class="form-control form-control-sm" id="nose_text" name="nose"
                    value="<?php if ($row['nose'] !='มีรูจมูก 2 ข้าง'
                                            &&$row['nose'] !='รูจมูกตัน') {echo htmlspecialchars($row['nose']);}?>"
                    <?php if (!($row['nose'] !='มีรูจมูก 2 ข้าง'
                                            &&$row['nose'] !='รูจมูกตัน'
                                            &&$row['nose'] != NULL)) {echo 'disabled';}?>
                >
            </div>
    ...
    <div class="row">
      &nbsp;&nbsp;&nbsp;&nbsp;<label>ปาก ลิ้น</label>
          <div class="custom-control custom-radio col-sm-1">
            &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['mouth'] == 'ปกติ')  {echo 'checked="checked"';} ?>
                      class="custom-control-input" id="mouth1" name="mouth" value="ปกติ"
                      onchange="mouth_check('off_checked');">
                       <label class="custom-control-label" for="mouth1">ปกติ</label>
  </div>
  <div class="custom-control custom-radio col-sm-1">
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['mouth'] == 'ปากแหว่ง')  {echo 'checked="checked"';} ?>
              class="custom-control-input" id="mouth2" name="mouth" value="ปากแหว่ง"
              onchange="mouth_check('off_checked');">
               <label class="custom-control-label" for="mouth2">ปากแหว่ง</label>
</div>

<div class="custom-control custom-radio col-sm-1">
  &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['mouth'] == 'เพดานโหว่')  {echo 'checked="checked"';} ?>
            class="custom-control-input" id="mouth3" name="mouth" value="เพดานโหว่"
            onchange="mouth_check('off_checked');">
...
<div class="custom-control custom-radio col-sm-1">
    <input type="radio" <?php if ($row['mouth'] !='ปกติ'
                                &&$row['mouth'] !='ปากแหว่ง'
                                &&$row['mouth'] !='เพดานโหว่'
                                &&$row['mouth'] != NULL) {echo 'checked="checked"';} ?>
        class="custom-control-input" id="mouth4" onchange="mouth_check('on_checked');">
    <label class="custom-control-label" for="mouth4">ผิดปกติิ</label>
</div>

<div class="col-sm-5">
    <input type="text" class="form-control form-control-sm" id="mouth_text" name="mouth"
        value="<?php if ($row['mouth'] !='ปกติ'
                                    &&$row['mouth'] !='ปากแหว่ง'
                                    &&$row['mouth'] !='เพดานโหว่') {echo htmlspecialchars($row['mouth']);}?>"
        <?php if (!($row['mouth'] !='ปกติ'
                                    &&$row['mouth'] !='ปากแหว่ง'
                                    &&$row['mouth'] !='เพดานโหว่'
                                    &&$row['mouth'] != NULL)) {echo 'disabled';}?>
    >
</div>
        ...
        <div class="row">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;<label>คอ</label>
              <div class="custom-control custom-radio col-sm-1">
                &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['neck'] == 'ปกติ')  {echo 'checked="checked"';} ?>
                          class="custom-control-input" id="neck1" name="neck" value="ปกติ"
                          onchange="neck_check('off_checked');">
                           <label class="custom-control-label" for="neck1">ปกติ</label>
      </div>

      <div class="custom-control custom-radio col-sm-1">
        &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['neck'] != 'ปกติ' && $row['neck'] != NULL)  {echo 'checked="checked"';} ?>
    ...
    <div class="col-sm-5">
     <input type="text" class="form-control form-control-sm" id="neck_text" name="neck"
                value="<?php if ($row['neck'] != 'ปกติ' && $row['neck'] != NULL) {echo htmlspecialchars($row['neck']);}?>"
    ...
    <div class="row">
      &nbsp;&nbsp;&nbsp;&nbsp;<label>ท้อง</label>
          <div class="custom-control custom-radio col-sm-1">
            &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['abdomen'] == 'ปกติ')  {echo 'checked="checked"';} ?>
                      class="custom-control-input" id="abdomen1" name="abdomen" value="ปกติ"
                      onchange="abdomen_check('off_checked');">
                       <label class="custom-control-label" for="abdomen1">ปกติ</label>
  </div>
  <div class="custom-control custom-radio col-sm-1">
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['abdomen'] == 'ท้องอืด')  {echo 'checked="checked"';} ?>
              class="custom-control-input" id="abdomen2" name="abdomen" value="ท้องอืด"
              onchange="abdomen_check('off_checked');">
...
<div class="custom-control custom-radio col-sm-1">
    <input type="radio" <?php if ($row['abdomen'] !='ปกติ'
                                &&$row['abdomen'] !='ท้องอืด'
                                &&$row['abdomen'] != NULL) {echo 'checked="checked"';} ?>
        class="custom-control-input" id="abdomen3" onchange="abdomen_check('on_checked');">
    <label class="custom-control-label" for="abdomen3">ผิดปกติิ</label>
</div>

<div class="col-sm-5">
    <input type="text" class="form-control form-control-sm" id="abdomen_text" name="abdomen"
        value="<?php if ($row['abdomen'] !='ปกติ'
                                    &&$row['abdomen'] !='ท้องอืด') {echo htmlspecialchars($row['abdomen']);}?>"
        <?php if (!($row['abdomen'] !='ปกติ'
                                    &&$row['abdomen'] !='ท้องอืด'
                                    &&$row['abdomen'] != NULL)) {echo 'disabled';}?>
    >
</div>
    ...
    <div class="row">
      &nbsp;&nbsp;&nbsp;&nbsp;<label>สะดือ</label>
          <div class="custom-control custom-radio col-sm-1">
            &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['navel'] == 'ปกติ')  {echo 'checked="checked"';} ?>
                      class="custom-control-input" id="navel1" name="navel" value="ปกติ"
                      onchange="navel_check('off_checked');">
                       <label class="custom-control-label" for="navel1">ปกติ</label>
  </div>
  <div class="custom-control custom-radio col-sm-1">
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['navel'] == 'Omphalocele')  {echo 'checked="checked"';} ?>
              class="custom-control-input" id="navel2" name="navel" value="Omphalocele"
              onchange="navel_check('off_checked');">
               <label class="custom-control-label" for="navel2">Omphalocele</label>
</div>

<div class="custom-control custom-radio col-sm-1">
  &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['navel'] == 'Gastroschisis')  {echo 'checked="checked"';} ?>
            class="custom-control-input" id="navel3" name="navel" value="Gastroschisis"
            onchange="navel_check('off_checked');">
...
<div class="custom-control custom-radio col-sm-1">
    <input type="radio" <?php if ($row['navel'] !='ปกติ'
                                ...
                                &&$row['navel'] != NULL) {echo 'checked="checked"';} ?>
        class="custom-control-input" id="navel4" onchange="navel_check('on_checked');">
    <label class="custom-control-label" for="navel4">ผิดปกติิ</label>
</div>

<div class="col-sm-5">
    <input type="text" class="form-control form-control-sm" id="navel_text" name="navel"
        value="<?php if ($row['navel'] !='ปกติ'
                                    &&$row['navel'] !='Omphalocele'
                                    &&$row['navel'] !='Gastroschisis') {echo htmlspecialchars($row['navel']);}?>"
        <?php if (!($row['navel'] !='ปกติ'
                                    &&$row['navel'] !='Omphalocele'
                                    &&$row['navel'] !='Gastroschisis'
                                    &&$row['navel'] != NULL)) {echo 'disabled';}?>
    >
</div>
    ...
    <br>
        <div class="row">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;<label>กระดูกสันหลัง</label>
              <div class="custom-control custom-radio col-sm-1">
                &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['spine'] == 'ปกติ')  {echo 'checked="checked"';} ?>
                          class="custom-control-input" id="spine1" name="spine" value="ปกติ"
                          onchange="spine_check('off_checked');">
                           <label class="custom-control-label" for="spine1">ปกติ</label>
      </div>

      <div class="custom-control custom-radio col-sm-1">
        &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['spine'] != 'ปกติ' && $row['spine'] != NULL)  {echo 'checked="checked"';} ?>
    ...
    <div class="col-sm-5">
     <input type="text" class="form-control form-control-sm" id="spine_text" name="spine"
                value="<?php if ($row['spine'] != 'ปกติ' && $row['spine'] != NULL) {echo htmlspecialchars($row['spine']);}?>"
        ...
        <div class="row">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;<label>แขนขา</label>
              <div class="custom-control custom-radio col-sm-1">
                &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['limbs'] == 'ปกติ')  {echo 'checked="checked"';} ?>
                          class="custom-control-input" id="limbs1" name="limbs" value="ปกติ"
                          onchange="limbs_check('off_checked');">
                           <label class="custom-control-label" for="limbs1">ปกติ</label>
      </div>

      <div class="custom-control custom-radio col-sm-1">
        &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['limbs'] != 'ปกติ' && $row['limbs'] != NULL)  {echo 'checked="checked"';} ?>
    ...
    <div class="col-sm-5">
     <input type="text" class="form-control form-control-sm" id="limbs_text" name="limbs"
                value="<?php if ($row['limbs'] != 'ปกติ' && $row['limbs'] != NULL) {echo htmlspecialchars($row['limbs']);}?>"
        ...
        <div class="row">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;<label>อวัยวะเพศ</label>
              <div class="custom-control custom-radio col-sm-1">
                &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['genitalia'] == 'ปกติ')  {echo 'checked="checked"';} ?>
                          class="custom-control-input" id="genitalia1" name="genitalia" value="ปกติ"
                          onchange="genitalia_check('off_checked');">
                           <label class="custom-control-label" for="genitalia1">ปกติ</label>
      </div>

      <div class="custom-control custom-radio col-sm-1">
        &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['genitalia'] != 'ปกติ' && $row['genitalia'] != NULL)  {echo 'checked="checked"';} ?>
    ...
    <div class="col-sm-5">
     <input type="text" class="form-control form-control-sm" id="genitalia_text" name="genitalia"
                value="<?php if ($row['genitalia'] != 'ปกติ' && $row['genitalia'] != NULL) {echo htmlspecialchars($row['genitalia']);}?>"
...
<br>
    ...
    <div class="row">
      &nbsp;&nbsp;&nbsp;&nbsp;<label>สีผิว</label>
          <div class="custom-control custom-radio col-sm-1">
            &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['skin_color'] == 'แดง')  {echo 'checked="checked"';} ?>
                      class="custom-control-input" id="skin_color1" name="skin_color" value="แดง"
                      onchange="skin_color_check('off_checked');">
                       <label class="custom-control-label" for="skin_color1">แดง</label>
  </div>
  <div class="custom-control custom-radio col-sm-1">
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['skin_color'] == 'ซีด')  {echo 'checked="checked"';} ?>
              class="custom-control-input" id="skin_color2" name="skin_color" value="ซีด"
              onchange="skin_color_check('off_checked');">
               <label class="custom-control-label" for="skin_color2">ซีด</label>
</div>

<div class="custom-control custom-radio col-sm-1">
  &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['skin_color'] == 'เขียว')  {echo 'checked="checked"';} ?>
            class="custom-control-input" id="skin_color3" name="skin_color" value="เขียว"
            onchange="skin_color_check('off_checked');">
...
<div class="custom-control custom-radio col-sm-1">
    <input type="radio" <?php if ($row['skin_color'] !='แดง'
                                ...
                                &&$row['skin_color'] != NULL) {echo 'checked="checked"';} ?>
        class="custom-control-input" id="skin_color4" onchange="skin_color_check('on_checked');">
    <label class="custom-control-label" for="skin_color4">ผิดปกติิ</label>
</div>

<div class="col-sm-5">
    <input type="text" class="form-control form-control-sm" id="skin_color_text" name="skin_color"
        value="<?php if ($row['skin_color'] !='แดง'
                                &&$row['skin_color'] !='ซีด'
                                &&$row['skin_color'] !='เขียว') {echo htmlspecialchars($row['skin_color']);}?>"
        <?php if (!($row['skin_color'] !='แดง'
                                &&$row['skin_color'] !='ซีด'
                                &&$row['skin_color'] !='เขียว'
                                    &&$row['skin_color'] != NULL)) {echo 'disabled';}?>
    >
</div>
    ...
    <div class="row">
      &nbsp;&nbsp;&nbsp;&nbsp;<label>การแสดงออกด้านพฤติกรรม</label>
          <div class="custom-control custom-radio col-sm-1">
            &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['behavior'] == 'เฉย')  {echo 'checked="checked"';} ?>
                      class="custom-control-input" id="behavior1" name="behavior" value="เฉย"
                      onchange="behavior_check('off_checked');">
                       <label class="custom-control-label" for="behavior1">เฉย</label>
  </div>
  <div class="custom-control custom-radio col-sm-1">
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['behavior'] == 'ร้องไห้')  {echo 'checked="checked"';} ?>
              class="custom-control-input" id="behavior2" name="behavior" value="ร้องไห้"
              onchange="behavior_check('off_checked');">
...
<div class="custom-control custom-radio col-sm-1">
    <input type="radio" <?php if ($row['behavior'] !='เฉย'
                                ...
                                &&$row['behavior'] != NULL) {echo 'checked="checked"';} ?>
...
<div class="col-sm-5">
    <input type="text" class="form-control form-control-sm" id="behavior_text" name="behavior"
        value="<?php if ($row['behavior'] !='เฉย'
                                    &&$row['behavior'] !='ร้องไห้') {echo htmlspecialchars($row['behavior']);}?>"
        <?php if (!($row['behavior'] !='เฉย'
                                    &&$row['behavior'] !='ร้องไห้'
                                    &&$row['behavior'] != NULL)) {echo 'disabled';}?>
    >
</div>
    ...
    <div class="row">
      &nbsp;&nbsp;&nbsp;&nbsp;<label>การแสดงออกด้านอารมณ์</label>
          <div class="custom-control custom-radio col-sm-1">
            &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['expression'] == 'ประเมินไม่ได้')  {echo 'checked="checked"';} ?>
                      class="custom-control-input" id="expression1" name="expression" value="ประเมินไม่ได้"
                      onchange="expression_check('off_checked');">
                       <label class="custom-control-label" for="expression1">ประเมินไม่ได้</label>
  </div>
  <div class="custom-control custom-radio col-sm-1">
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" <?php if ($row['expression'] == 'ร้องโกรธ')  {echo 'checked="checked"';} ?>
              class="custom-control-input" id="expression2" name="expression" value="ร้องโกรธ"
              onchange="expression_check('off_checked');">
...
<div class="custom-control custom-radio col-sm-1">
    <input type="radio" <?php if ($row['expression'] !='ประเมินไม่ได้'
                                ...
                                &&$row['expression'] != NULL) {echo 'checked="checked"';} ?>
...
<div class="col-sm-5">
    <input type="text" class="form-control form-control-sm" id="expression_text" name="expression"
        value="<?php if ($row['expression'] !='ประเมินไม่ได้'
                                    &&$row['expression'] !='ร้องโกรธ') {echo htmlspecialchars($row['expression']);}?>"
        <?php if (!($row['expression'] !='ประเมินไม่ได้'
                                    &&$row['expression'] !='ร้องโกรธ'
                                    &&$row['expression'] != NULL)) {echo 'disabled';}?>
    >
</div>
