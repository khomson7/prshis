                ...
                <div class="card">
                    <div class="card-body" style=" overflow-y: auto;">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;<label>การตรวจประเมินแรกรับ&nbsp;</label>
                                    <div class="col-sm-8">
                                    ...
                                    &nbsp; วัน-เดือน-ปี &nbsp;<div class="col-sm-1">
                                    <input type="date" class="form-control form-control-sm" id="pe_1st_date" name="pe_1st_date" value="<?= (isset($row['pe_1st_date']) ? htmlspecialchars($row['pe_1st_date']) : '') ?>">
                                </div>
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="id" name="id" value="<?= $admission_note_id ?>">
                    ...
                    <script>
                        ...
                        function form_save() {
                           ...
                           // var rxtime = $.trim($('[name="rxtime"]').val());
                            ...
                            var url_update = "form-rehab-history-update.php";
                            var url_save = "form-rehab-history-save.php";
                            var id = $("#id").val();
