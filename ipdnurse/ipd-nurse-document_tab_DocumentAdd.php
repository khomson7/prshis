                    ...
                    <li class="nav-item active dropdown">
                        <li class="nav-item active dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><em class="fas fa-plus"></em> เพิ่มเอกสาร</a>
...
<script>
    function onclick_check_DocumentAdd(){
        var url = "ipdnurse/ipd-nurse-document_check_DocumentAdd.php";
    ...
    function check_Table_DocumentEdit(){
        var url = "ipdnurse/ipd-nurse-document_Table_DocumentEdit.php";
        var an  = <?=json_encode($an)?>;
        $.post(url,{an},function(data){
