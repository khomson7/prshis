<?php  // require_once './project/function/Session.php';
       ...
       require_once '../mains/ipd-show-patient-main-sticky.php';
        ...
        if($admission_note_id == null){
            $sql_opdscreen="SELECT opdscreen.hn,opdscreen.cc,opdscreen.hpi,
                            opdscreen.pe_ga_text, opdscreen.pe_heent_text,
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                value="<?php    if ($admission_note_id != null){
                                                    ...
                                                    if (isset($row_old_ipt['old_regdatetime'])) {echo htmlspecialchars(KphisConstant::KPHIS_HOSPITAL_NAME);}
                                                }?>">
                            </div>
                        </div>
                        <div class="form-group row">
      ...
      //  $operation_text = "";
            ...
            ?>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-md-2">
                            <a class="btn btn-secondary btn-sm PhysicalExaminationBtn" href="#" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><em class="fas fa-user"></em> Skin</a>
                        <div class="dropdown-menu" aria-labelledby="dropdownId">
                 <?php
                 //  General
                     $sql_phy = "SELECT pe_general_text,name_select
                    FROM ".DbConstant::KPHIS_DBNAME.".prs_phy_exam_list where exam_group_id = '2' and type_of_person = 'A' and active_ = 'Y' and user_ in('master','$loginname')";
        $stmt_phy = $conn->prepare($sql_phy);
        $stmt_phy->execute($reg_parameters);
        $rows_phy  = $stmt_phy->fetchAll();
      //  $operation_text = "";
            foreach ($rows_phy as $ds) {
                ?>
                <a class="dropdown-item" onclick="onclick_Normal('pe_skin','<?= $ds['pe_general_text'] ?>')"> <?= $ds['name_select'] ?></a>
                <?php
                 $i++;
            }
            ...
            ?>
                    ...
                    <a class="btn btn-secondary btn-sm PhysicalExaminationBtn" href="#"  data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false">
                        <i class="fa fa-baby" aria-hidden="true"></i> Skin</a>
                    <div class="dropdown-menu" aria-labelledby="DropdownId">

                    <?php
                 //  General
                     $sql_phy = "SELECT pe_general_text,name_select
                    FROM ".DbConstant::KPHIS_DBNAME.".prs_phy_exam_list where exam_group_id = '2' and type_of_person = 'B' and active_ = 'Y' and user_ in('master','$loginname')";
        $stmt_phy = $conn->prepare($sql_phy);
        $stmt_phy->execute($reg_parameters);
        $rows_phy  = $stmt_phy->fetchAll();
      //  $operation_text = "";
            ...
            ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                            <a class="btn btn-secondary btn-sm PhysicalExaminationBtn" href="#" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><em class="fas fa-user"></em> HEENT</a>
                        <div class="dropdown-menu" aria-labelledby="dropdownId">
                 <?php
                 //  General
                     $sql_phy = "SELECT pe_general_text,name_select
                    FROM ".DbConstant::KPHIS_DBNAME.".prs_phy_exam_list where exam_group_id = '3' and type_of_person = 'A' and active_ = 'Y' and user_ in('master','$loginname')";
        $stmt_phy = $conn->prepare($sql_phy);
        $stmt_phy->execute($reg_parameters);
        $rows_phy  = $stmt_phy->fetchAll();
      //  $operation_text = "";
            foreach ($rows_phy as $ds) {
                ?>
                <a class="dropdown-item" onclick="onclick_Normal('pe_heent','<?= $ds['pe_general_text'] ?>')"> <?= $ds['name_select'] ?></a>
                <?php
                 $i++;
            }
            ...
            ?>
                    ...
                    <a class="btn btn-secondary btn-sm PhysicalExaminationBtn" href="#"  data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false">
                        <i class="fa fa-baby" aria-hidden="true"></i> HEENT</a>
                    <div class="dropdown-menu" aria-labelledby="DropdownId">

                    <?php
                 //  General
                     $sql_phy = "SELECT pe_general_text,name_select
                    FROM ".DbConstant::KPHIS_DBNAME.".prs_phy_exam_list where exam_group_id = '3' and type_of_person = 'B' and active_ = 'Y' and user_ in('master','$loginname')";
        $stmt_phy = $conn->prepare($sql_phy);
        $stmt_phy->execute($reg_parameters);
        $rows_phy  = $stmt_phy->fetchAll();
      //  $operation_text = "";
            ...
            ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                            <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?=(isset($row['pe_other']) ? htmlspecialchars($row['pe_other']) : '')?>" id="pe_other" name="pe_other">
                            </div>
                            <div class="col-md-1">
                               <a class="btn btn-secondary btn-sm PhysicalExaminationBtn" href="#" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false"><em class="fas fa-user"></em> Other</a>
                           <div class="dropdown-menu" aria-labelledby="dropdownId">
                    <?php
                    //  General
                        $sql_phy = "SELECT pe_general_text,name_select
                       FROM ".DbConstant::KPHIS_DBNAME.".prs_phy_exam_list where exam_group_id = '13' and type_of_person = 'A' and active_ = 'Y' and user_ in('master','$loginname')";
           $stmt_phy = $conn->prepare($sql_phy);
           $stmt_phy->execute($reg_parameters);
           $rows_phy  = $stmt_phy->fetchAll();
         //  $operation_text = "";
               foreach ($rows_phy as $ds) {
                   ?>
                   <a class="dropdown-item" onclick="onclick_Normal('pe_other','<?= $ds['pe_general_text'] ?>')"> <?= $ds['name_select'] ?></a>
                   <?php
                    $i++;
               }
               ...
               ?>
                        ...
                        <div class="form-group row">
                            ...
                            <a class="btn btn-secondary btn-sm PhysicalExaminationBtn" href="#" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><em class="fas fa-user"></em> PEText</a>
                        <div class="dropdown-menu" aria-labelledby="dropdownId">
                 <?php
                 //  General
                     $sql_phy = "SELECT pe_general_text,name_select
                    FROM ".DbConstant::KPHIS_DBNAME.".prs_phy_exam_list where exam_group_id = '14' and type_of_person = 'A' and active_ = 'Y' and user_ in('master','$loginname')";
        $stmt_phy = $conn->prepare($sql_phy);
        $stmt_phy->execute($reg_parameters);
        $rows_phy  = $stmt_phy->fetchAll();
      //  $operation_text = "";
            foreach ($rows_phy as $ds) {
                ?>
                <a class="dropdown-item" onclick="onclick_Normal('pe_text','<?= $ds['pe_general_text'] ?>')"> <?= $ds['name_select'] ?></a>
                <?php
                 $i++;
            }
