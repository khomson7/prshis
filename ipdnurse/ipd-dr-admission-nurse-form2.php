...
$aa = $row_formtype['c_form_type'];
$var = 'Metallica';


/*
if ( $aa == 1) {
    $var1 = 'ipd-dr-admission-nurse-form.php?an=aa';
    echo "<script type='text/javascript'>
 
   console.log(jsvar); 
    document.location.href='ipd-dr-admission-nurse-form.php?an=';
    </script>";
  }else{
                    ...
                    <div class="form-group row">
                        ...
                        <B>อายุครรภ์</B>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row_opdscreen['pe_ga_text']) && $admission_note_id == null ? htmlspecialchars($row_opdscreen['pe_ga_text']) : htmlspecialchars($row['pe_general'])) ?>" id="pe_general" name="pe_general" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row['pe_head']) ? htmlspecialchars($row['pe_head']) : '') ?>" id="pe_head" name="pe_head" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row['pe_neck']) ? htmlspecialchars($row['pe_neck']) : '') ?>" id="pe_neck" name="pe_neck" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row['pe_face']) ? htmlspecialchars($row['pe_face']) : '') ?>" id="pe_face" name="pe_face" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row['pe_ears']) ? htmlspecialchars($row['pe_ears']) : '') ?>" id="pe_ears" name="pe_ears" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row['pe_eyes']) ? htmlspecialchars($row['pe_eyes']) : '') ?>" id="pe_eyes" name="pe_eyes" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row['pe_nose']) ? htmlspecialchars($row['pe_nose']) : '') ?>" id="pe_nose" name="pe_nose" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row['pe_mouth']) ? htmlspecialchars($row['pe_mouth']) : '') ?>" id="pe_mouth" name="pe_mouth" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row['pe_chest']) ? htmlspecialchars($row['pe_chest']) : '') ?>" id="pe_chest" name="pe_chest" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row_opdscreen['pe_lung_text']) && $admission_note_id == null ? htmlspecialchars($row_opdscreen['pe_lung_text']) : htmlspecialchars($row['pe_lungs'])) ?>" id="pe_lungs" name="pe_lungs" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row_opdscreen['pe_heart_text']) && $admission_note_id == null ? htmlspecialchars($row_opdscreen['pe_heart_text']) : htmlspecialchars($row['pe_heart'])) ?>" id="pe_heart" name="pe_heart" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row_opdscreen['pe_ab_text']) && $admission_note_id == null ? htmlspecialchars($row_opdscreen['pe_ab_text']) : htmlspecialchars($row['pe_abdomen'])) ?>" id="pe_abdomen" name="pe_abdomen" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row['pe_anus']) ? htmlspecialchars($row['pe_anus']) : '') ?>" id="pe_anus" name="pe_anus" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row_opdscreen['pe_ext_text']) && $admission_note_id == null ? htmlspecialchars($row_opdscreen['pe_ext_text']) : htmlspecialchars($row['pe_extremities'])) ?>" id="pe_extremities" name="pe_extremities" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row['pe_trunk_spine']) ? htmlspecialchars($row['pe_trunk_spine']) : '') ?>" id="pe_trunk_spine" name="pe_trunk_spine" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row['pe_nervose']) ? htmlspecialchars($row['pe_nervose']) : '') ?>" id="pe_nervose" name="pe_nervose" readonly>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-9">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row['impression']) ? htmlspecialchars($row['impression']) : '') ?>" id="impression" name="impression" readonly>
                                            </div>
                                            <div class="col-md-1">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control form-control-sm PhysicalExaminationInput" value="<?= (isset($row['plan_management']) ? htmlspecialchars($row['plan_management']) : '') ?>" id="plan_management" name="plan_management" readonly>
                                            </div>
                                            <div class="col-md-1">
