...
<form id="admit_firsth" action=""  method="post"  enctype="multipart/form-data">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-11">
                <h4>แบบบันทึกการรับใหม่ผู้ป่วยใน (ENT) <?=htmlspecialchars(DbConstant::HOSPITAL_NAME)?></h4>
            </div>
        </div><p></p>
...
<!--
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 text-right">
                ...
                <a href="ipd-ent-admission-note-pdf.php?an=<?php echo $an;?>&admission_note_id=<?php echo $admission_note_id;?>&loginname=<?php echo $loginname; ?>" target="_blank" class="btn btn-secondary"><i class="fas fa-file-pdf"></i> ENT screening Print</a>
                <?php
                //รอแก้ไข
               // $a = 1;
