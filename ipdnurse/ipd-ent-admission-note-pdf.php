...
//$image_check = ' / ';
    ...
    $checkbox_allergy_2 = '( )';
        ...
        $svg_tag1 = str_replace('<?xml version="1.0" encoding="UTF-8" standalone="no" ?>','',$row['svg_tag1']);
        $svg_tag1 = str_replace('width="700" height="180"',' height="180"',$svg_tag1);

        $svg_tag2 = str_replace('<?xml version="1.0" encoding="UTF-8" standalone="no" ?>','',$row['svg_tag2']);
        $svg_tag2 = str_replace('width="700" height="180"',' height="180"',$svg_tag2);

        $svg_tag3 = str_replace('<?xml version="1.0" encoding="UTF-8" standalone="no" ?>','',$row['svg_tag3']);
        $svg_tag3 = str_replace('width="700" height="180"',' height="175"',$svg_tag3);

        $svg_tag4 = str_replace('<?xml version="1.0" encoding="UTF-8" standalone="no" ?>','',$row['svg_tag4']);
        $svg_tag4 = str_replace('width="700" height="180"',' height="180"',$svg_tag4);

        $svg_tag5 = str_replace('<?xml version="1.0" encoding="UTF-8" standalone="no" ?>','',$row['svg_tag5']);
        $svg_tag5 = str_replace('width="700" height="170"',' height="170"',$svg_tag5);
$head =
'
    <style>
        body{
    ...
    <h2 style="text-align:right;font-size:8pt;">คลินิกโสต ศอ นาสิก</h2>
    <h2 style="text-align:center;font-size:11pt;">ENT screening '.htmlspecialchars(DbConstant::HOSPITAL_NAME).'</h2>
    ...
    <table id="bg-table" width="100%" style="border-collapse: collapse;font-size:8pt;margin-top:2px;">
        ...
        <tr style="border:1px solid #000;margin: 45px;">
        <td  colspan="2" width="50%" style="border-right:0.5px solid #000;margin: 35px;padding:4px;text-align:left;"  id="show_img_select1">'.$svg_tag1.'</td>
        <td  width="50%" style="border-right:0.5px solid #000;margin: 35px;padding:4px;text-align:left;" id="show_img_select2">'.$svg_tag2.'</td>
    </tr>
        ...
        <table id="bg-table" width="100%" style="border-collapse: collapse;font-size:8pt;margin-top:2px;">
    <tr style="border:1px solid #000;margin: 45px;">
    <td  colspan="2" width="50%" style="border-right:0.5px solid #000;margin: 35px;padding:4px;text-align:left;" id="show_img_select3">'.$svg_tag3.'</td>
    <td  width="50%" style="border-right:0.5px solid #000;margin: 35px;padding:4px;text-align:left;" id="show_img_select4">'.$svg_tag4.'</td>
</tr>
        </table>

        <table id="bg-table" width="100%" style="border-collapse: collapse;font-size:8pt;margin-top:2px;">
        <tr style="border:1px solid #000;margin: 45px;">
        <td  colspan="2" width="50%" style="border-right:0.5px solid #000;margin: 35px;padding:4px;text-align:left;" id="show_img_select5">'.$svg_tag5.'</td>
        <td  width="50%" style="border-right:0.5px solid #000;margin: 35px;padding:4px;text-align:left;" id="show_img_select">'.'</td>
    </tr>
            </table>
