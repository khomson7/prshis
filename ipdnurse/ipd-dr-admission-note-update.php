<?php   require_once '../include/Session.php';
        ...
        $version = $version + 1;
            // empty($_REQUEST['']) ? null : $_REQUEST[''];
             ...
             $special_room = empty($_REQUEST['special_room']) ? null : $_REQUEST['special_room'];
            //$c_mother_his = 'abc';
        ...
        try {
            ...
            take_medication_by=:take_medication_by,arrive_by=:arrive_by,
            taken_by_relative=:taken_by_relative,taken_by_nurse=:taken_by_nurse,taken_by_crib=:taken_by_crib,taken_by_etc=:taken_by_etc,
            taken_by=:taken_by,informant_patient=:informant_patient,
            informant_relatives=:informant_relatives, informant_deliverer=:informant_deliverer,
            informant_etc=:informant_etc, chief_complaints=:chief_complaints, medical_history=:medical_history, bp=:bp, t=:t,
            pr=:pr, rr=:rr, gcs=:gcs, e=:e, v=:v,m=:m, braden_scale=:braden_scale, disease=:disease,
            disease_detail=:disease_detail,
            disease_etc=:disease_etc, operation_history=:operation_history, allergy_history=:allergy_history, allergy_drug_history_hosxp=:allergy_drug_history_hosxp,
            allergy_drug_history=:allergy_drug_history, allergy_food_history=:allergy_food_history,
            allergy_etc_history=:allergy_etc_history, allergy_detail=:allergy_detail, family_medical_history=:family_medical_history, family_medical_history_detail=:family_medical_history_detail, 
            receives_immunisation_history_kid=:receives_immunisation_history_kid, developmentally_kid=:developmentally_kid,
            g=:g, p=:p, anc=:anc, tt=:tt, gestational_age=:gestational_age,gestational_day=:gestational_day,
            last_child=:last_child,last_abort=:last_abort,curette=:curette,lmp=:lmp,edc=:edc,pb_no=:pb_no,giant_baby=:giant_baby,
            distocia=:distocia,extraction=:extraction,pph=:pph,pb_etc=:pb_etc,hf=:hf,hf_position=:hf_position,
            hiv=:hiv,vdrl=:vdrl,hbs_ag=:hbs_ag,hct=:hct,hiv2=:hiv2,vdrl2=:vdrl2,hbs_ag2=:hbs_ag2,hct2=:hct2,
            ...
            fant_artificial_feeding_start_age_month=:fant_artificial_feeding_start_age_month, fant_feeding_etc=:fant_feeding_etc,
            ...
            ,pe_anus=:pe_anus,pe_trunk_spine=:pe_trunk_spine,pe_nervose=:pe_nervose,c_form_type=:c_form_type,c_mother_his=:c_mother_his,review_of_system=:review_of_system,special_room=:special_room
            ...
            'receives_immunisation_history_kid'=>$receives_immunisation_history_kid, 'developmentally_kid'=>$developmentally_kid,
            'g'=>$g, 'p'=>$p, 'anc'=>$anc, 'tt'=>$tt, 'gestational_age'=>$gestational_age,'gestational_day'=>$gestational_day,
            'last_child'=>$last_child,'last_abort'=>$last_abort,'curette'=>$curette,'lmp'=>$lmp,'edc'=>$edc,'pb_no'=>$pb_no,
            'giant_baby'=>$giant_baby,'distocia'=>$distocia,'extraction'=>$extraction,'pph'=>$pph,'pb_etc'=>$pb_etc,'hf'=>$hf,'hf_position'=>$hf_position,
            'hiv'=>$hiv,'vdrl'=>$vdrl,'hbs_ag'=>$hbs_ag,'hct'=>$hct,'hiv2'=>$hiv2,'vdrl2'=>$vdrl2,'hbs_ag2'=>$hbs_ag2,'hct2'=>$hct2,
            'gr'=>$gr,'thalassemia'=>$thalassemia,'husband'=>$husband,
            'condition_pregnant'=>$condition_pregnant,
            'deliver_anomalies'=>$deliver_anomalies, 'deliver_anomalies_means'=>$deliver_anomalies_means, 'deliver_location'=>$deliver_location,
            'deliver_first_weight'=>$deliver_first_weight,'deliver_first_health'=>$deliver_first_health,
            'fant_breast_feeding_end_age_month'=>$fant_breast_feeding_end_age_month,
            'fant_artificial_feeding_start_age_month'=>$fant_artificial_feeding_start_age_month, 'fant_feeding_etc'=>$fant_feeding_etc,
            'supplementary_feeding'=>$supplementary_feeding,'supplementary_feeding_start_age_month'=>$supplementary_feeding_start_age_month,
            'disease_operation_allergy'=>$disease_operation_allergy, 'inpatient_history'=>$inpatient_history,
