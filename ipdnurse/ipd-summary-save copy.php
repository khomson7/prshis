...
require_once '../include/KphisQueryUtils.php';
  ...
  //  Session::checkLoginSessionAndShowMessage(); //เช็ค session
    ...
    */
    ...
    try {
        $stmt = $conn->prepare("INSERT INTO ".KphisConstant::HOSXP_CONNECTION_KPHIS_DBNAME.".ipd_summary (summary_plan_date,summary_plan_time,principal_diagnosis,pre_admission_comorbidity,post_admission_comorbidity,other_diagnosis,external_cause,operating_room,tracheostomy,mechanical_ventilation,mechanical_ventilation1,
