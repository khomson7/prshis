...
<buton >
<a class="nav-link" href="/pdffile/mental-health2-pdf.php?an=<?php echo $an; ?>&loginname=<?php echo $loginname; ?>" target="_blank" class="btn btn-secondary"><i class="fas fa-file-pdf"></i> Print <U>PDF</U> File</a>
</buton> 
...
<script>
    function onclick_check_DocumentAdd(){
        var url = "prs-health2_check_DocumentAdd.php";
    ...
    function check_Table_DocumentEdit(){
        var url = "prs-health2_Table_DocumentEdit.php";
        var an  = <?=json_encode($an)?>;
        $.post(url,{an},function(data){
