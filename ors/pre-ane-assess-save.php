...
// Checkbox fields (value = 1 if checked)
$checkbox_fields = [
...
$params['an'] = $an;
$params['create_user'] = isset($_SESSION['loginname']) ? $_SESSION['loginname'] : null;
$params['update_user'] = $params['create_user'];
$params['create_datetime'] = date('Y-m-d H:i:s');

// Build INSERT
$cols = array_keys($params);
$placeholders = array_map(function($c){ return ":$c"; }, $cols);
$sql = "INSERT INTO " . DbConstant::KPHIS_DBNAME . ".prs_pre_ane_assess (" . implode(',', $cols) . ") VALUES (" . implode(',', $placeholders) . ")";
