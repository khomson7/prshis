                                    ...
                                    <tr id="row-<?= $row['id'] ?>" <?= ($new_id && $row['id'] == $new_id) ? 'class="table-success new-record"' : '' ?>>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($row['nurse_position']): ?>
                                                <br><small
                                                    class="text-muted"><?= htmlspecialchars($row['nurse_position']) ?></small>
                                            <?php endif; ?>
                                        </td>
                                        <td><?= $row['created_at'] ? date('d/m/Y H:i', strtotime($row['created_at'])) : '-' ?>
                                        </td>
                                        <td><?= $row['updated_at'] ? date('d/m/Y H:i', strtotime($row['updated_at'])) : '-' ?>
                                        </td>
                                        <td class="text-center">
                                            ...
                                            <?php if ($canEdit && \ReportQueryUtils::checkReadOnly($an) && $row['created_by'] === $loginname): ?>
                                                <button type="button"
                                                    onclick="deleteRecord(<?= $row['id'] ?>, '<?= date('d/m/Y', strtotime($row['visit_date'] ?: 'now')) ?> <?= htmlspecialchars($row['shift'] ?: '') ?>')"
