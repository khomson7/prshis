...
$head = '
        ...
        <h4 style="text-align:center;">'.htmlspecialchars(KphisConstant::KPHIS_HOSPITAL_NAME).'<br>ใบ Record Intake - Output for one day</h4>
...
';
        ...
        $sql_group_date = " SELECT io.io_date FROM ".KphisConstant::HOSXP_CONNECTION_KPHIS_DBNAME.".ipd_io io WHERE io.an = :an ";
